...
public class modificar_eliminar extends AppCompatActivity {
   ...
   // private RequestQueue queue;
      ...
      //  queue= Volley.newRequestQueue(this);
        ...
        actualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               String men =  base.actualizarPersona(nom,ap,tel,corr,fech,gen,asig,bec);
                ...
                if (men.equals("si")){
                    client.excecute("http://optativa3.herokuapp.com/editar");
                }else{
                    client.excecute("http://optativa3.herokuapp.com/error");
                }
                Intent i = new Intent(modificar_eliminar.this, Login.class);
    ...
    public void recibirArreglo(){
        ...
        if (arreglo!=null){
            per = (Persona) arreglo.getSerializable("persona");
